...
local window =
    library:new(
    {textsize = 13.5, font = Enum.Font.RobotoMono, name = "Cookies hub | Premium education", color = Color3.fromRGB(255, 46, 31)}
)
...
local Main5 = Main:section({name = "// Material \\", side = "left", size = 175})
...
Main2:dropdown(
    {
        ...
        def = "",
        max = 10,
        options = {"Fighting style","Sword","Gun","Devil fruit"},
        callback = function(vu)
            print(vu)
        end
    }
...
Main2:dropdown(
    {
        ...
        def = "",
        max = 10,
        options = {"None","Fast attacks","Super fast attacks","Ultimate fast attacks"},
        callback = function(vu)
            print(vu)
        end
    }
